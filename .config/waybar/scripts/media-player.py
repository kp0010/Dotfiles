...
class PlayerManager:
    def __init__(self, selected_player=None, excluded_players=[]):
        ...
        self.excluded_players = excluded_players.split(
            ',') if excluded_players else []
    ...
    def on_metadata_changed(self, player, metadata, _=None):
        ...
        if metadata:
            try:
                ...
                logger.error(f"Error accessing metadata for player {
                             player_name}: {e}")
